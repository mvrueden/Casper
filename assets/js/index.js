...
$("#search-field").ghostHunter({
    ...
    includepages: true,
    result_template : "<a href='{{link}}'><li class='search-result-item gh-search-item'>{{title}} <span class='label label-info'>{{featured}}</span> <span class='label label-default'>{{tags}}</span></li></a>",
